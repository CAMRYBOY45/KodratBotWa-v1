...
let _promote = JSON.parse(fs.readFileSync('./database/promote.json'))
let _demote = JSON.parse(fs.readFileSync('./database/demote.json'))
...
async function startalpha() {
   ...
   alpha.ev.on('group-participants.update', async (anu) => {
      ...
      welcome(alpha, anu, ownername, reSize, isWelcome, isLeft, isPromote, isDemote)
   })
